...
- Ở parent component, sử dụng `provide` để specify the data/methods chúng ta muốn được share với các child component
- Sau đó ở descendants, chúng ta sử dụng `inject` để rêcive specific properties mà chúng ta mong muốn mà đã được provided ở trên.
*/

/*
Programmatic Event Listeners
- Cho đến hiện tại, chúng ta mới chỉ sử dụng `$emit` và listen event với `v-on`, nhưng Vue instance đồng thời cung cấp các methods đối với events interface, ví dụ:
